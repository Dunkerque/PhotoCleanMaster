                ...
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                          ...
                          <ul class="collapse" id="menu1">
                              <li><a href="edit-order.php">Modifier une commande</a></li>
                    ...
                    <li>
                        <a data-toggle="collapse" data-target="#menu2" aria-expanded="false" aria-controls="menu2">
                         ...
                         <ul class="collapse" id="menu2">
                              <li><a href="add-shipment.php">Ajouter les frais de ports</a></li>
                              <li><a href="edit-shipment.php">Modifier les frais de ports</a></li>
                              <li><a href="#">Supprimer les frais de ports</a></li>
                              <li><a href="#">Voir les frais de ports</a></li>
                          </ul>
                    ...
                    <li>
                        <a data-toggle="collapse" data-target="#menu3" aria-expanded="false" aria-controls="menu3"><i class="fa fa-fw fa-table"></i>Formats</a>
                          ...
                          <ul class="collapse" id="menu3">
                              <li><a href="#">Ajouter un formats</a></li>
                              <li><a href="#">Supprimer les formats</a></li>
                              <li><a href="#">Voir tous les formats</a></li>
                          </ul>
                    </li>
                    <li>
                        <a href="forms.html"><i class="fa fa-fw fa-edit"></i>Messages</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
